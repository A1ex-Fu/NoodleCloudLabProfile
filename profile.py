...
# All ASCII-only characters to avoid PEP‑0263 encoding errors.
#
...
class G:
    ...
    base_ip  = "10.10.1."      # node0..node3 -> .1..4
    hw_node  = "xl170"
    hw_sw    = "dell-s4048"
...
# Optional parameter: choose switch hardware
pc.defineParameter(
    "phystype",
    "Switch type",
...
def make_node(idx, name, run_cmd):
    ...
    # Build testConfig2.txt contents
    cfg_lines = [
        "f 0",
